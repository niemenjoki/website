...
PI-säädin riittää käytännössä useimpiin säätötilanteisiin, ainakin rakennusautomaation yhteydessä. Lähes aina, kun tulee mieleen käyttää D-komponenttia, varsinainen ongelma on jokin muu kuin D-komponentin puuttuminen, ainakin rakennusautomaation yhteydessä. Jotkut sanovatkin, että PID-säätimen D-kirjain tulee lauseesta "Do not use".

Omat kokemukseni rakennusautomaation parissa ovat vahvistaneet tätä ajatusta. En ole kuuden vuoden rakennusautomaation parissa työskentelyn aikana käyttänyt D-komponenttia kertaakaan.
...
Kun säädintä halutaan välillä pysäyttää ja käynnistää uudelleen, yllä olevan koodin mukaisen säätimen arvo lähtee kasvattamaan tulostaan nollasta ylöspäin, kun virhe kasvaa. Tämä on ongelmallista erityisesti, jos säädetään prosessia, jonka säätöarvo on normaalitilanteessa aina korkea.

Usein onkin tarpeen määrittää niin sanottu tasapainopiste, jonka ympärillä säätimen tulos muuttuu. Usein tasapainopiste on hyvä asettaa esimerkiksi säädön minimi- ja maksiarvojen puoleen väliin, mutta myös muille tasapainopisteille on käyttötarkoituksensa.

Itse määritän lämpöpumppujärjestelmän apuna toimivan sähkökattilan tehonsäädölle tasapainopisteeksi nollan, jotta sähkökattila lähtee tarvittaessa pikkuhiljaa kasvattamaan tehoaan nollasta. Toisaalta, jos saman sähkökattilan tehoa on tarvetta rajoittaa esimerkiksi liian suuren järjestelmän kokonaisvirran estämiseksi, asetan rajoitussäätimen tasapainopisteen 100 %:iin, jotta se ei säätimen käynnistyessä vaikuta sähkökattilaan, vaan alkaa laskemaan tehoa maksimista alaspäin vain tarvittaessa.
