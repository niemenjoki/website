...
<aside>
  ...
  <div>
    {' '}
    Olen kirjoittanut myös lämpöpumppujen sisäisen kylmäainepiirin toiminnasta. Jos
    lämpöpumppujen fysiikkaa kiinnostaa, julkaisu löytyy täältä:{' '}
    <a href="https://niemenjoki.fi/blogi/julkaisu/kuinka-lampopumput-toimivat">
