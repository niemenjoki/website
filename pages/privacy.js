    ...
    >
      <div className={classes.PrivacyPage}>
        ...
        <p>
          ...
          collect information. You're free to continue using this website even
          if you use ad blockers or any other services that prevent the use of
          data collecting third party services on this website.
        </p>
        ...
        <p>
          ...
          Please refer to Google's privacy policies for more details on how they
          handle this data:{' '}
          <a
        ...
        <h2>Cookies</h2>
        <p>
          This website itself doesn't use cookies but it utilizes third-party
          services that use them. You can instruct your browser to refuse all
